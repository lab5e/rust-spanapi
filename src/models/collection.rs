...
pub struct Collection {
    ...
    #[serde(rename = "upstreamTimestamps", skip_serializing_if = "Option::is_none")]
    pub upstream_timestamps: Option<Vec<String>>,
    #[serde(
        rename = "downstreamTimestamps",
        skip_serializing_if = "Option::is_none"
    )]
    pub downstream_timestamps: Option<Vec<String>>,
}
...
impl Collection {
    ...
    pub fn new() -> Collection {
        Collection {
            ...
            firmware: None,
            tags: None,
            upstream_timestamps: None,
            downstream_timestamps: None,
        }
    }
}
