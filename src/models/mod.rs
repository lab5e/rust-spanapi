...
pub mod create_gateway_request;
pub use self::create_gateway_request::CreateGatewayRequest;
...
pub mod update_gateway_request;
pub use self::update_gateway_request::UpdateGatewayRequest;
