...
pub async fn data_dump(configuration: &configuration::Configuration, body: crate::models::DataDumpRequest) -> Result<crate::models::DataDumpResponse, Error<DataDumpError>> {
