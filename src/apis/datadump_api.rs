...
/// struct for typed errors of method `span_data_dump`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SpanDataDumpError {
...
pub async fn span_data_dump(configuration: &configuration::Configuration, body: serde_json::Value) -> Result<crate::models::DataDumpResponse, Error<SpanDataDumpError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SpanDataDumpError> = serde_json::from_str(&local_var_content).ok();
