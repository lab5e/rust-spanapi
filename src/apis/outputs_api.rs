...
pub async fn create_output(configuration: &configuration::Configuration, collection_id: &str, body: crate::models::CreateOutputRequest) -> Result<crate::models::Output, Error<CreateOutputError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/span/collections/{collectionId}/outputs", local_var_configuration.base_path, collectionId=crate::apis::urlencode(collection_id));
...
pub async fn delete_output(configuration: &configuration::Configuration, collection_id: &str, output_id: &str) -> Result<crate::models::Output, Error<DeleteOutputError>> {
    ...
    let local_var_uri_str = format!("{}/span/collections/{collectionId}/outputs/{outputId}", local_var_configuration.base_path, collectionId=crate::apis::urlencode(collection_id), outputId=crate::apis::urlencode(output_id));
...
pub async fn logs(configuration: &configuration::Configuration, collection_id: &str, output_id: &str) -> Result<crate::models::OutputLogResponse, Error<LogsError>> {
    ...
    let local_var_uri_str = format!("{}/span/collections/{collectionId}/outputs/{outputId}/logs", local_var_configuration.base_path, collectionId=crate::apis::urlencode(collection_id), outputId=crate::apis::urlencode(output_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn status(configuration: &configuration::Configuration, collection_id: &str, output_id: &str) -> Result<crate::models::OutputStatusResponse, Error<StatusError>> {
    ...
    let local_var_uri_str = format!("{}/span/collections/{collectionId}/outputs/{outputId}/status", local_var_configuration.base_path, collectionId=crate::apis::urlencode(collection_id), outputId=crate::apis::urlencode(output_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn update_output(configuration: &configuration::Configuration, existing_collection_id: &str, output_id: &str, body: crate::models::UpdateOutputRequest) -> Result<crate::models::Output, Error<UpdateOutputError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/span/collections/{existingCollectionId}/outputs/{outputId}", local_var_configuration.base_path, existingCollectionId=crate::apis::urlencode(existing_collection_id), outputId=crate::apis::urlencode(output_id));
