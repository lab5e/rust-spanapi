...
pub async fn broadcast_message(
    ...
    collection_id: &str,
    body: crate::models::BroadcastMessageRequest,
) -> Result<crate::models::MultiSendMessageResponse, Error<BroadcastMessageError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BroadcastMessageError> =
