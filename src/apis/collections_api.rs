...
/// struct for typed errors of method `broadcast_message`
...
pub async fn broadcast_message(configuration: &configuration::Configuration, collection_id: &str, body: crate::models::BroadcastMessageRequest) -> Result<crate::models::MultiSendMessageResponse, Error<BroadcastMessageError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BroadcastMessageError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn create_collection(configuration: &configuration::Configuration, body: crate::models::Collection) -> Result<crate::models::Collection, Error<CreateCollectionError>> {
...
pub async fn update_collection(configuration: &configuration::Configuration, collection_id: &str, body: crate::models::Collection) -> Result<crate::models::Collection, Error<UpdateCollectionError>> {
