...
pub async fn delete_blob(
    ...
    collection_id: &str,
    blob_id: &str,
) -> Result<serde_json::Value, Error<DeleteBlobError>> {
    ...
    let local_var_uri_str = format!(
        ...
        blobId = crate::apis::urlencode(blob_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteBlobError> =
...
pub async fn list_blobs(
    ...
    collection_id: &str,
    limit: Option<i32>,
) -> Result<crate::models::ListBlobResponse, Error<ListBlobsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListBlobsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
