...
pub async fn get_system_info(configuration: &configuration::Configuration, ) -> Result<crate::models::SystemInfoResponse, Error<GetSystemInfoError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/span/system", local_var_configuration.base_path);
